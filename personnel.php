<?php
    ...
    $sql = "INSERT INTO secel_gestion1.personnel(id_personnel, nom_personnel, role_personnel, mot_de_passe)VALUES(?, ?, ?, ?)";
        ...
        if ( $req->rowCount()!=0) {
            ...
            $_SESSION['message']['text'] = "Une erreur s'est produite lors de l'ajout du personnel";
