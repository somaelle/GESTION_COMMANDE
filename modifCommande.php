...
$sql = "UPDATE commande SET id_commande=?, num_client=?, id_personnel=?, nrbre_commande=?, date_commande=? WHERE id_commande=?";
    ...
    if ( $req->rowCount()!=0) {
        $_SESSION['message']['text'] = "commande modifié avec succès";
    ...
    <div class="overview-boxes">
        <div class="box">
            <form action="" method="post"enctype="multipart/form.data">
                ...
                <label for="num_client">num_client <span class="text-danger">*</label>
                ...
                <label for="id_personnel">id_personnel <span class="text-danger">*</label>
